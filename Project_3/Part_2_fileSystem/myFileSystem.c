...
MyFileSystem createMyFileSystem(MyFileSystem* fileSystem, char diskName[]){
...
int createFile(MyFileSystem* fileSystem, char name[8], int32_t size){
...
int deleteFile(MyFileSystem* fileSystem, char name[8]){
...
int ls(MyFileSystem* fileSystem){
...
int readFile(MyFileSystem* fileSystem, char name[8], int32_t blockNum, char buf[1024]){
...
int writeFile(MyFileSystem* fileSystem, char name[8], int32_t blockNum, char buf[1024]){
